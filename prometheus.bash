...
if [ "$EUID" -ne 0 ]; then
    ...
    echo ""
    echo "     curl -sSL https://raw.githubusercontent.com/aaaSaZaN/fast-prometheus-setup/refs/heads/main/prometheus.bash | sudo bash"
    echo ""
    echo "     curl -sSL https://raw.githubusercontent.com/aaaSaZaN/fast-prometheus-setup/refs/heads/main/prometheus.bash -o /tmp/s.bash && sudo bash /tmp/s.bash"
    echo ""
